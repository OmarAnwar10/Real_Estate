    ...
    public class PropertyService_Dto : IPropertyService_Dto
    {
        ...
        public void CreateProperty(PropertywithAmenitiesDto propertyDto)
        {
            ...
            try
            {
                ...
                numberInBinary += propertyDto.IsFurnished?"1":"0";
                numberInBinary += propertyDto.HasCentralHeating ? "1" : "0";
                numberInBinary += propertyDto.HasParking ? "1" : "0";
                numberInBinary += propertyDto.HasBalcony ? "1" : "0";
                numberInBinary += propertyDto.HasElevator ? "1" : "0";
                numberInBinary += propertyDto.HasGarden ? "1" : "0";
                numberInBinary += propertyDto.HasPool ? "1" : "0";
                numberInBinary += propertyDto.Laundry_Room ? "1" : "0";
                numberInBinary += propertyDto.Two_Stories ? "1" : "0";
                numberInBinary += propertyDto.HasGarage ? "1" : "0";
                int amenityId = Convert.ToInt32(numberInBinary, 2);
                property.AmenitiesId = amenityId;
                ///end
